...
{&(RES0__INSTANCE0.ENTRANCEGATESENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.ENTRANCEGATESENSOR0), BOOL_ENUM},
{&(RES0__INSTANCE0.TICKETVALIDATIONENTER), BOOL_ENUM},
{&(RES0__INSTANCE0.TICKETVALIDATIONEXIT), BOOL_ENUM},
{&(RES0__INSTANCE0.PHYSICALCARDENTER), BOOL_ENUM},
{&(RES0__INSTANCE0.PHYSICALCARDEXIT), BOOL_ENUM},
{&(RES0__INSTANCE0.PERMITCARDENTER), BOOL_ENUM},
{&(RES0__INSTANCE0.PERMITCARDEXIT), BOOL_ENUM},
{&(RES0__INSTANCE0.OPENSPOTSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.COUNTSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERSTAYNOTIFICATION), BOOL_ENUM},
{&(RES0__INSTANCE0.OPENENTRYGATE), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERSTAYSIGNAGE), BOOL_ENUM},
{&(RES0__INSTANCE0.AVAILABLESPOTSIGNAGE), BOOL_ENUM},
{&(RES0__INSTANCE0.LICENSEPLATECAPTURE), BOOL_ENUM},
{&(RES0__INSTANCE0.LICENSEPLATEVERIFICATION), BOOL_ENUM},
{&(RES0__INSTANCE0.ENTRANCEPASSTHROUGH), BOOL_ENUM},
{&(RES0__INSTANCE0.ALARMBUTTON), BOOL_ENUM},
{&(RES0__INSTANCE0.TEMPSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.PARKINGLED), BOOL_ENUM},
{&(RES0__INSTANCE0.ALARMACTIVATE), BOOL_ENUM},
{&(RES0__INSTANCE0.HEALTHDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.CLOSEENTRYGATE), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTSENSOR), INT_ENUM},
{&(RES0__INSTANCE0.SETLIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.RAINSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.SNOWSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.CLEARWEATHER), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTCONTROL), BOOL_ENUM},
{&(RES0__INSTANCE0.RAINSIGNAGE), BOOL_ENUM},
{&(RES0__INSTANCE0.SNOWSIGNAGE), BOOL_ENUM},
{&(RES0__INSTANCE0.CLEARSIGNAGE), BOOL_ENUM},
{&(RES0__INSTANCE0.PARKINGTIMER), INT_ENUM},
{&(RES0__INSTANCE0.PARKINGLIMIT), INT_ENUM},
{&(RES0__INSTANCE0.PARKINGDURATIONSTATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERSTAYDETECTOR), BOOL_ENUM},
{&(RES0__INSTANCE0.TICKETVALIDATIONSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.PAYMENTMACHINEDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.EVSENSORSTATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.EVCHARGERACTIVATION), BOOL_ENUM},
{&(RES0__INSTANCE0.EXITSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.EXITPASSTHROUGHSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.LICENSEPLATECAPTURESYSTEM), WORD_ENUM},
{&(RES0__INSTANCE0.EXITGATEOPENS), BOOL_ENUM},
{&(RES0__INSTANCE0.EXITGATECLOSES), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTSENSORCONDITION), INT_ENUM},
{&(RES0__INSTANCE0.HMIENTRYDISPLAYTRIGGER), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERSTAYPENALTYINDICATOR), BOOL_ENUM},
{&(RES0__INSTANCE0.PARKINGSPOTDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.ALARMSTATUSINDICATOR), BOOL_ENUM},
{&(RES0__INSTANCE0.TEMPERATUREDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTNINGSTATUSDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.WEATHERCONDITIONDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.PARKINGDURATIONOVERSTAY), WORD_ENUM},
{&(RES0__INSTANCE0.EXITEVENTDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.PAYMENTPROCESSDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.SYSTEMHEALTHCHECKDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.MANUALOVERRIDEGATE), BOOL_ENUM},
{&(RES0__INSTANCE0.MANUALOVERRIDEALARM), BOOL_ENUM},
{&(RES0__INSTANCE0.MANUALOVERRIDELIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.EVENTLOGDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0.STATUSSYNCTRIGGER), BOOL_ENUM},
{&(RES0__INSTANCE0.MAINTENANCEMODEDISPLAY), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LE61_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT41_OUT), BOOL_ENUM}
};
